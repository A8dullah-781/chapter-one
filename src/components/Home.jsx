...
// });
  ...
  return (
    ...
    data-scroll
      data-scroll-section
      data-scroll-speed="-.8"
    className=" h-screen overflow-x-hidden relative z-10 w-full">
      ...
      <div className="sm:mt-[15vh] md:mt-[5vh]   lg:mt-[8vh] mt-[10vh]  leading-none justify-center flex-col items-center flex text-[#533116]">
       
       
<div className="wrapper flex flex-col lg:flex-row gap-2 lg:gap-25">

        <div className="maintext font-[one] ">
          <div className="lhr text-[6vw] lg:text-[4vw]    ">LAHORE</div>
          <div className="text-[12vw] mt-1 lg:text-[8vw] ">CHAPTER</div>
          <div className="flex one lg:-mt-5 -mt-2 ">
            <img
              className=" w-[10.5vw] 
                          [@media(min-width:380px) and (max-width:639px)]:w-[10.5vw]
                         md:w-[8vw]
                         lg:w-[7vw] 

                         h-[6vh]
                          [@media(min-width:380px) and (max-width:639px)]:h-[11vw]
                         md:h-[11vw] 
                         lg:h-[7.5vw] 
                        
                         
                         
                         bean lg:-mr-1 text-[#533116]"
              src="/images/bean.png"
              alt=""
            />
            ...
            <div className="timings lg:flex hidden mt-2  flex-col justify-center items-center lg:w-[45vw] w-[70vw] rounded-4xl bg-[#bed9eb]">
        ...
        <div>
         <div className="mainpic flex justify-center ">
          <img
            className="lg:w-[30vw] md:w-[60vw]  w-[70vw]  rounded-4xl"
            src="/images/mainpic.png"
            alt=""
          />
       
        </div>
        <div className="timings lg:hidden block mt-2 flex flex-col justify-center items-center lg:w-[45vw] w-[70vw] rounded-4xl bg-[#bed9eb]">
            <div className="lg:text-[2.5vw] text-[5vw] font-[two]  pt-4 uppercase">Opening Hours</div>
            <div className="flex justify-center items-center gap-10 p-4">
              <div className="lg:text-[3.5vw] text-[4.5vw] font-[one]  uppercase">MON - SUN</div>
              <div className="lg:text-[2.5vw] text-[4.5vw] font-[two]   uppercase">9am - 2am</div>
    ...
    {/* <div className="hidden lg:block">
          ...
          className="absolute lehar bottom-0 left-0 w-full sm:h-[37vh] md:h-[25vh] lg:h-[16vh] h-[9vh] "
        >
          <path
            id="wavePath"
            ref={waveRef}
        ...
        <svg
          ...
          viewBox="0 0 1200 120"
          preserveAspectRatio="none"
          className="absolute lehar bottom-0 left-0 w-full sm:h-[32vh] md:h-[20vh] lg:h-[12vh] h-[6vh] "
        >
          <path
            id="wavePath"
            ref={waveRef}
