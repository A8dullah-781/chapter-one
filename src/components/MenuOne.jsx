...
useGSAP(() => {
  ...
  return (
    <div className=" h-auto justify-center flex items-center bg-[#533116]">
      <div className="bg-[#9b663a] h-auto flex  rounded-4xl w-[90%]">
        <div className="w-1/2 h-auto rounded-4xl  text-[#f2e5bc] ">

        <div className="title items-center flex flex-col">
          <div className="font-[one] text-[5.5vw] px-5 pt-5">COLD BREWS</div>
        <div className="font-[two2] text-[1.5vw] border-b-1 pb-5 ">Served hot, on ice, and blended -- Just let your barista know</div>
        </div>
        <div className="allitems">

        <div className="menuitem   pl-8 ">
          ...
          <div className="flex items-center justify-between border-b-1 pb-5 ">
            <div className="text-[1.2vw] font-[two2]  text-left w-[60%]">Lorem ipsum dolor, sit amet consectetur .</div>
        ...
        <div className="menuitem   pl-8 ">
          ...
          <div className="flex items-center justify-between border-b-1 pb-5 ">
           ...
           <div className="w-1/2 h-full rounded-4xl relative">
      <div
        ref={sectionRef} 
